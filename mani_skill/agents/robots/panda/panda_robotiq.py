...
@register_agent()
class PandaRobotiqWristCamera(BaseAgent):
    uid = "panda_robotiq_wristcam"
    urdf_path = f"{PACKAGE_ASSET_DIR}/robots/panda/panda_robotiq_wristcam.urdf"
    urdf_config = dict(
        _materials=dict(
    ...
    def _after_loading_articulation(self):
        ...
        gripper_links = [
            ...
            "right_inner_finger",
            "left_inner_finger",
            "panda_link7",  # not gripper link but is adjacent to the gripper part
        ]
