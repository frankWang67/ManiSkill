...
@register_agent()
class UR5RobotiqWristCamera(UR5):
    uid = "ur5_robotiq_wristcam"
    urdf_path = f"{PACKAGE_ASSET_DIR}/robots/ur/ur5_robotiq_wristcam.urdf"
    urdf_config = dict(
        _materials=dict(
    ...
    def _after_loading_articulation(self):
        ...
        gripper_links = [
            ...
            "right_inner_finger",
            "left_inner_finger",
            "wrist_3_link",  # not gripper link but is adjacent to the gripper part
        ]
