...
@register_agent()
class Rizon4RobotiqWristCamera(BaseAgent):
    uid = "rizon4_robotiq_wristcam"
    urdf_path = f"{PACKAGE_ASSET_DIR}/robots/flexiv/rizon4_robotiq_wristcam.urdf"
    urdf_config = dict(
        _materials=dict(
    ...
    def _after_loading_articulation(self):
        ...
        gripper_links = [
            ...
            "right_inner_finger",
            "left_inner_finger",
            "link7",  # not gripper link but is adjacent to the gripper part
        ]
